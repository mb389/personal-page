  ...
  render() {
    return (
      ...
      <div className="sidebar-item sidebar-header">
        <ul id="social">
         <li>
             <a href="http://www.github.com/mb389" rel="noopener" target="_blank" className="btn-social"><i className="fa fa-fw fa-github"></i></a>
         </li>
         <li>
             <a href="https://www.facebook.com/michael.bushoy" rel="noopener" target="_blank" className="btn-social"><i className="fa fa-fw fa-facebook"></i></a>
         </li>
         <li>
             <a href="https://www.linkedin.com/in/michaelbushoy" rel="noopener" target="_blank" className="btn-social"><i className="fa fa-fw fa-linkedin"></i></a>
         </li>
         <li>
             <a href="https://angel.co/mb389" rel="noopener" target="_blank" className="btn-social"><i className="fa fa-fw fa-angellist"></i></a>
         </li>
       </ul>
      </div>
